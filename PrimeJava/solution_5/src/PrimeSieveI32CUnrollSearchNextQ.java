public class PrimeSieveI32CUnrollSearchNextQ extends PrimeSieveBase{
	...
	public PrimeSieveI32CUnrollSearchNextQ(int sieveSize) {
		super(sieveSize);
	...
	public static void main(String[] args) throws InterruptedException {
		PrimeSieveBase.run(() -> new PrimeSieveI32CUnrollSearchNextQ(1000000), args);
	}
}
