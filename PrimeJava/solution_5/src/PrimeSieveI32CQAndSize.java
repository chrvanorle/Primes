public class PrimeSieveI32CQAndSize extends PrimeSieveBaseBit{
	...
	public PrimeSieveI32CQAndSize(int sieveSize) {
		super(sieveSize);
	...
	public static void main(String[] args) throws InterruptedException {
		PrimeSieveBase.run(() -> new PrimeSieveI32CQAndSize(1000000), args);
	}
}
