public class PrimeSieveI32CUnrollQAndSize extends PrimeSieveBase{
	...
	public PrimeSieveI32CUnrollQAndSize(int sieveSize) {
		super(sieveSize);
	...
	public void runSieve() {
		...
		for (int factor = 3; factor <= q && factor <= sieveSize; factor += 2) {
			if (getBit(factor)) {
				clearBits(factor);
			}
		}
	...
	public static void main(String[] args) throws InterruptedException {
		PrimeSieveBase.run(() -> new PrimeSieveI32CUnrollQAndSize(1000000), args);
	}
}
