public class PrimeSieveI32CSearchNextQ extends PrimeSieveBaseBit{
	...
	public PrimeSieveI32CSearchNextQ(int sieveSize) {
		super(sieveSize);
	...
	public static void main(String[] args) throws InterruptedException {
		PrimeSieveBase.run(() -> new PrimeSieveI32CSearchNextQ(1000000), args);
	}
}
