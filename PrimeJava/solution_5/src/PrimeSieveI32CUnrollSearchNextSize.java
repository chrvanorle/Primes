public class PrimeSieveI32CUnrollSearchNextSize extends PrimeSieveBase{
	...
	public PrimeSieveI32CUnrollSearchNextSize(int sieveSize) {
		super(sieveSize);
	...
	public static void main(String[] args) throws InterruptedException {
		PrimeSieveBase.run(() -> new PrimeSieveI32CUnrollSearchNextSize(1000000), args);
	}
}
