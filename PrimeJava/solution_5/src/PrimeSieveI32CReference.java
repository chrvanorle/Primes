public class PrimeSieveI32CReference extends PrimeSieveBaseBit{
	...
	public PrimeSieveI32CReference(int sieveSize) {
		super(sieveSize);
	...
	public static void main(String[] args) throws InterruptedException {
		PrimeSieveBase.run(() -> new PrimeSieveI32CReference(1000000), args);
	}
}
