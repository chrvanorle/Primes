public class PrimeSieveI32CUnrollReference extends PrimeSieveBase{
	...
	public PrimeSieveI32CUnrollReference(int sieveSize) {
		super(sieveSize);
	...
	public static void main(String[] args) throws InterruptedException {
		PrimeSieveBase.run(() -> new PrimeSieveI32CUnrollReference(1000000), args);
	}
}
